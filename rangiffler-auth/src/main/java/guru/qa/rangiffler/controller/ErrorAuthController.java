...
import static guru.qa.rangiffler.service.GlobalExceptionHandler.ERROR_MESSAGE_PARAM;
import static guru.qa.rangiffler.service.GlobalExceptionHandler.ORIGINAL_CODE_PARAM;
...
public class ErrorAuthController implements ErrorController {
  ...
  public String error(HttpServletRequest request,
    ...
    model.addAttribute("frontUri", rangifflerFrontUri + "/main");
